...
void SampleBase::onInit(HINSTANCE hInstance, HWND hWnd)
{
    ...
    init_info.QueueFamily = globals.device.queues.graphics.familyIndex;
...
void SampleBase::createGraphicsCommandBuffers()
{
    ...
    createInfo.queueFamilyIndex = globals.device.queues.graphics.familyIndex;
    VK_CHECK(
...
void SampleBase::drawFrame()
{
    ...
    if (result == VK_ERROR_OUT_OF_DATE_KHR) {
        ...
        VK_CHECK(result, __FILE__, __LINE__, "Failed to acquire next image");
    }
